        ...
        public void OnUpdate(ref SystemState state)
        {
                         ...
                         .WithEntityAccess())
            {
                skillShotAbilityCommand.Send(
                    abilityCommand, commandEntity, state.EntityManager, ecb);
                
                abilityCommand.DrawAbilityUI<SkillShotAbilityCommand>(
                    state.EntityManager, ecb, isServer);
            }
    ...
    public partial struct SkillShotAbilityCommandJob : IJobEntity
    {
            ...
            AimInput aimInput, SkillShotAbilityCommand skillShotAbilityCommand, Entity owner)
        {
            ...
            cooldownTargetTicks.UpdateCooldown(
                abilityCooldownTicks, NetTime, skillShotAbilityCommand.AbilityIndex, IsServer);
        }
    }
}